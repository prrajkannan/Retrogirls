<section class="fcards">
		<div class="row" style="padding-left: 50px; padding-right: 50px;">
			<div class="col s12 m12 l4" style="padding: 50px 5px;">
				<div class="card">
				    <div class="card-image waves-effect waves-block waves-light">
				      <img class="activator" src="images/north.jpg">
				    </div>
			...
			<div class="col s12 m12 l4" style="padding: 50px 5px;">
				<div class="card">
				    <div class="card-image waves-effect waves-block waves-light">
				      <img class="activator" src="images/chinese.jpg">
				    </div>
				    <div class="card-content">
			...
			<div class="col s12 m12 l4" style="padding: 50px 5px;">
				<div class="card">
				    <div class="card-image waves-effect waves-block waves-light">
				      <img class="activator" src="images/south.jpg">
				    </div>
				    <div class="card-content">
				    ...
				    <div class="card-reveal">
				      ...
				      <p>South Indian cuisine includes the cuisines of the five southern states of India Tamil Nadu, Andhra Pradesh, Karnataka, Keralaand Telangana.</p>
				    </div>
				  </div>
			</div>
		</div>
